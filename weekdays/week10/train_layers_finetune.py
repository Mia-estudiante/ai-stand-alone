...
def main():
    ...
    optim = Adam([  {'params': [weight for name, weight in model.named_parameters() \
                                if name=='layer1'], 'lr': args.lr*0.01},
                    {'params': [weight for name, weight in model.named_parameters() \
                                if name=='layer2'], 'lr': args.lr*0.01},
                    {'params': [weight for name, weight in model.named_parameters() \
                                if name=='layer3'], 'lr': args.lr*0.01},
                    {'params': [weight for name, weight in model.named_parameters() \
                                if name=='layer4'], 'lr': args.lr*0.01},
